...
var Player = React.createClass({
    ...
    changeName: function () {
        ...
        if (newPlayerName !== null) {
            ...
            ReactDOM.render(React.createElement(Grid, { data: this.props.data }), document.getElementById("content"));
        }
    },
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    "div",
                    null,
                    localStore.getPlayerName("a"),
                    " : ",
                    localStore.getWins("a")
                ),
                React.createElement(
                    "div",
                    null,
                    localStore.getPlayerName("b"),
                    " : ",
                    localStore.getWins("b")
                )
            ),
            React.createElement(
                "div",
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(Player, { name: player1Name, id: "a", next_turn: nextTurn, data: data }),
                React.createElement(Player, { name: player2Name, id: "b", next_turn: nextTurn, data: data })
            )
        );
    }
});
...
ReactDOM.render(React.createElement(Game, { url: url }), document.getElementById("content"));

},{"./localStore.js":161,"jquery":29,"react":159,"react-dom":30}],161:[function(require,module,exports){
"use strict";
